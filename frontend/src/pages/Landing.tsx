        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-4 sm:gap-6">
              ...
              <a href="https://github.com/adammuizweb/leah#readme" target="_blank" rel="noreferrer" className="text-sm text-gray-600 hover:text-indigo-600 font-medium">Docs</a>
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg sm:text-xl text-gray-600 leading-relaxed max-w-2xl">
              ...
              — semua dalam satu platform self-hosted yang ringan dan cepat.
            </p>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-gradient-to-br from-indigo-600 to-purple-700 rounded-2xl p-10 sm:p-16">
            ...
            <p className="mt-4 text-lg text-indigo-100 max-w-lg mx-auto">
              Kelola infrastrukturnya sendiri tanpa vendor lock-in.
            </p>
            <Link
              to="/dashboard"
